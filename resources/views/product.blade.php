        ...
        <div class="ourteam1">
            <div class="container1">
                <div class="card1">
                    <div class="content1">
                        <div class="imgBx">
                            <img src="asset/img/pr5.jpg" alt="">
                        </div>
                        <div class="contentBx">
                            <h3>Round-neck knitted sweater<br><span>3,600,000 VND</span><br> <span><i
                                        class="fa-solid fa-cart-plus"></i></span></h3>
                        </div>
                    </div>
                    <ul class="sci">
                ...
                <div class="card1">
                    <div class="content1">
                        <div class="imgBx">
                            <img src="asset/img/pr6.jpg" alt="">
                        </div>
                        <div class="contentBx">
                            <h3>Shearling denim jacket<br> <span>10,500,000 VND</span><br> <span><i
                                        class="fa-solid fa-cart-plus"></i></span></h3>
                        </div>
                    </div>
                    <ul class="sci">
                ...
                <div class="card1">
                    <div class="content1">
                        <div class="imgBx">
                            <img src="asset/img/pr7.jpg" alt="">
                        </div>
                        <div class="contentBx">
                            <h3>Tweed jacket with jewel<br><span>9,400,000 VND</span> <br> <span><i
                                        class="fa-solid fa-cart-plus"></i></span></h3>
                        </div>
                    </div>
                    <ul class="sci">
                ...
                <div class="card1">
                    <div class="content1">
                        <div class="imgBx">
                            <img src="asset/img/pr8.jpg" alt="">
                        </div>
                        <div class="contentBx">
                            <h3>Lapels Houndstooth suit<br><span>12,800,000 VND</span><br> <span><i
                                        class="fa-solid fa-cart-plus"></i></span></h3>
                        </div>
                    </div>
                    <ul class="sci">
            ...
            <div class="column column-20">
                ...
                <div class="container11">
                    <div class="card11">
                        <div class="content11">
                            <div class="imgBx1">
                                <img src="asset/img/pr10.jpg" alt="">
                            </div>
                ...
                <div class="ourteam12">
                    <div class="container12">
                        <div class="card12">
                            <div class="content12">
                                <div class="imgBx2">
                                    <img src="asset/img/pr11.jpg" alt="">
                                </div>
                        ...
                        <div class="card12">
                            <div class="content12">
                                <div class="imgBx2">
                                    <img src="asset/img/pr12.jpg" alt="">
                                </div>
                                <div class="contentBx2">
                                    <h3>Cashmere Wool Blazer <br><span> 8,500,000 VND</span> <br> <span><i
                                                class="fa-solid fa-cart-plus"></i></span></h3>
                        ...
                        <div class="card12">
                            <div class="content12">
                                <div class="imgBx2">
                                    <img src="asset/img/pr13.jpg" alt="">
                                </div>
                                <div class="contentBx2">
                                    <h3>Cashmere Wool Blazer <br><span> 8,500,000 VND</span> <br> <span><i
                                                class="fa-solid fa-cart-plus"></i></span></h3>
                ...
                <div class="ourteam12">
                    <div class="container12">
                        <div class="card12">
                            <div class="content12">
                                <div class="imgBx2">
                                    <img src="asset/img/pr14.jpg" alt="">
                                </div>
                                <div class="contentBx2">
                                    <h3>Cashmere Wool Blazer <br><span> 8,500,000 VND</span> <br> <span><i
                                                class="fa-solid fa-cart-plus"></i></span></h3>
                        ...
                        <div class="card12">
                            <div class="content12">
                                <div class="imgBx2">
                                    <img src="asset/img/pr15.jpg" alt="">
                                </div>
                                <div class="contentBx2">
                                    <h3>Cashmere Wool Blazer <br><span> 8,500,000 VND</span> <br> <span><i
                                                class="fa-solid fa-cart-plus"></i></span></h3>
                        ...
                        <div class="card12">
                            <div class="content12">
                                <div class="imgBx2">
                                    <img src="asset/img/pr16.jpg" alt="">
                                </div>
                                <div class="contentBx2">
                                    <h3>Cashmere Wool Blazer <br><span> 8,500,000 VND</span> <br> <span><i
                                                class="fa-solid fa-cart-plus"></i></span></h3>
